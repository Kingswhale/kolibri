    ...
    <p>
      <slot name="details">
         ...
         loadingLabel: {
           message: 'Loading…',
           context:
             'Message displayed when a resource is loading indicating that the user should wait.',
         },
         nameLabel: {
           message: 'Name',
         ...
         passwordLabel: {
           message: 'Password',
           context:
             "'Password' is a required field when you create an account as a user on Kolibri.",
         },
         profileLabel: {
           message: 'Profile',
         ...
         related: {
           message: 'Related',
           context:
             'Section header for the list of resources that are related to the current resource',
         },
         doNotShowAgain: {
         ...
         showResources: {
           ...
           context:
             'Subheader to filter resources with the options listed below (see the screenshot).',
         },
         // Notifications
         ...
         changesNotSavedNotification: {
           ...
           context:
             'Message that indicates that some changes that a user made have not been saved.',
         },
         ...
         genderOptionMale: {
           message: 'Male',
           context:
             "Male is an option in the 'Gender' drop down menu on the 'Create new user' page.",
         },
         genderOptionFemale: {
           message: 'Female',
           context:
             "Female is an option in the 'Gender' drop down menu on the 'Create new user' page.",
         },
